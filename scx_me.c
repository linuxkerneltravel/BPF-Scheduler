...
"  -S            Suppress qmap_me-specific debug dump\n"
...
int main(int argc, char **argv)
{
	...
	SCX_OPS_LOAD(skel, qmap_ops, scx_me, uei);
	link = SCX_OPS_ATTACH(skel, qmap_ops, scx_me);
